...
# Making a method to send the request to the server through the terminal.
def send_request(host, port, filename):
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as cl_socket:
        ...
        # sendall() sends all of the data in a single transmission and blocks until all the data has been sent.
